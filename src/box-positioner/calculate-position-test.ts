...
QUnit.test('test positions calculator', function(assert) {
  const tests: [string, calculationOptions, point, position][] = [
    ['on centre',                                      args( 50,  50),        point( 50,  45),  position( 50,  45, 'right')],
    // Edge caes
    ...
    ['far enough from right edge',                     args( 90,  50),        point( 90,  45),  position( 90,  45, 'right')],
    ['far enough from left edge',                      args(  5,  50),        point(  5,  45),  position(  5,  45, 'right')],
    ['far enough from top edge',                       args( 50,   5),        point( 50,   0),  position( 50,   0, 'right')],
    ['far enough from bottom edge',                    args( 50,  95),        point( 50,  90),  position( 50,  90, 'right')],
    ...
    ['far enough from top left edge',                  args(  0,   5),        point(  0,   0),  position(  0,   0, 'right')],
    ['far enough from top right edge',                 args( 90,   5),        point( 90,   0),  position( 90,   0, 'right')],
    ['far enough from bottom right edge',              args( 90,  95),        point( 90,  90),  position( 90,  90, 'right')],
    ['far enough from bottom left edge',               args(  0,  95),        point(  0,  90),  position(  0,  90, 'right')],
    ...
    ['on centre with offset',                          args( 50,  50, 5),     point( 50,  45),  position( 50,  45, 'right')],
    ...
    ['far enough from right edge offset',              args( 85,  50, 5),     point( 85,  45),  position( 85,  45, 'right')],
    ['far enough from left edge offset',               args(  5,  50, 5),     point(  5,  45),  position(  5,  45, 'right')],
    ['far enough from top edge offset',                args( 50,  10, 5),     point( 50,   5),  position( 50,   5, 'right')],
    ['far enough from bottom edge offset',             args( 50,  90, 5),     point( 50,  85),  position( 50,  85, 'right')],
    ...
    ['far enough from top left edge offset',           args(  5,  10, 5),     point(  5,   5),  position(  5,   5, 'right')],
    ['far enough from top right edge offset',          args( 85,  10, 5),     point( 85,   5),  position( 85,   5, 'right')],
    ['far enough from bottom right edge offset',       args( 85,  90, 5),     point( 85,  85),  position( 85,  85, 'right')],
    ['far enough from bottom left edge offset',        args(  5,  90, 5),     point(  5,  85),  position(  5,  85, 'right')],
    // Target with padding cases
    ['on centre with target padding',                  args( 50,  50, 0, 5),  point( 55,  45),  position( 55,  45, 'right')],
